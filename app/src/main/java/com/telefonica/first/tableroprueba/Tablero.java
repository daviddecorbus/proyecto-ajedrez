...
import static com.telefonica.first.tableroprueba.MainActivity.ejercicio;
import static com.telefonica.first.tableroprueba.MainActivity.turnoColor;
import static com.telefonica.first.tableroprueba.MainActivity.turnoResaltado;
            ...
            for (int j = 0; j < 8; j++) {
                ...
                if (guia.equalsIgnoreCase("vr")) {
                    ...
                    if (tablero[i][j].equalsIgnoreCase("br")) {
                        ...
                        MainActivity.xReyNegro = i;//actualiza la posición de los reyes
                        MainActivity.yReyNegro = j;
                    } else if (tablero[i][j].equalsIgnoreCase("wk")) {
                        piezas[i][j] = new Rey("wk", "wkr", "blanco", i, j, false, "wkj");
                        MainActivity.xReyBlanco = i;
                        MainActivity.yReyBlanco = j;
